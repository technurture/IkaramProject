        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link href="/blogs">
                <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-primary-800 px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg transition-all w-full sm:w-auto">
                  Explore Stories
                </Button>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-4 max-w-md mx-auto lg:mx-0">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">2,847</div>
                <div className="text-gray-700 text-xs sm:text-sm">Active Members</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">1,293</div>
                <div className="text-gray-700 text-xs sm:text-sm">Stories Shared</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-gray-900">156</div>
                <div className="text-gray-700 text-xs sm:text-sm">Events Hosted</div>
              </div>
            </div>
          </div>
