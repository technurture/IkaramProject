        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">CHS Ikaram</h3>
                <p className="text-gray-400">Old Students Association</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986s11.987-5.368 11.987-11.986C24.014 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.197-1.559-.357-.452-.566-1.016-.566-1.629 0-1.297.611-2.448 1.559-3.197C6.697 10.251 7.261 10.042 7.874 10.042c1.297 0 2.448.611 3.197 1.559.357.452.566 1.016.566 1.629 0 1.297-.611 2.448-1.559 3.197-.452.357-1.016.566-1.629.566zm7.718 0c-1.297 0-2.448-.611-3.197-1.559-.357-.452-.566-1.016-.566-1.629 0-1.297.611-2.448 1.559-3.197.452-.357 1.016-.566 1.629-.566 1.297 0 2.448.611 3.197 1.559.357.452.566 1.016.566 1.629 0 1.297-.611 2.448-1.559 3.197-.452.357-1.016.566-1.629.566z"/>
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              ...
              <span className="text-secondary-400 font-medium">TechNurture</span>
